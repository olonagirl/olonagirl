	...
	return (
		<main className="w-full bg-light">
			...
			<section className="flex w-full flex-col items-center px-5 py-20 lg:px-40">
				<p className="mb-5 font-vanity text-2xl lg:text-4xl">New Arrivals</p>
				<div className="grid w-full grid-cols-2 gap-2 lg:grid-cols-4 lg:gap-7">
					{collection.data
			...
			<section className="flex w-full flex-col items-center px-5 py-20 lg:px-40">
				<p className="mb-5 font-vanity text-2xl lg:text-4xl">Testimonials</p>
			</section>
			<section className="bg-fixed-1 h-[50dvh] w-full bg-dark/75 bg-cover bg-fixed bg-center bg-blend-multiply"></section>
			<section className="flex w-full flex-col items-center px-5 py-20 lg:px-40">
